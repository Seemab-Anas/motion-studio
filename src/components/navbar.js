    ...
    <nav className="fixed top-0 left-0 w-full z-50 px-4 py-3">
      <div className="flex justify-between items-center w-full max-w-7xl mx-auto h-[64px] bg-white shadow-md rounded-full px-6">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="relative group">
            ...
            <div className={`absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg overflow-hidden transition-all ${
              ...
              <Link href="/services/it-consultancy" className="block px-4 py-2 text-sm text-[#171824] hover:bg-gray-100">
                IT Consultancy
              </Link>
              <Link href="/services/financial-services" className="block px-4 py-2 text-sm text-[#171824] hover:bg-gray-100">
                Financial Services
              </Link>
            </div>
          </div>
        ...
        <button
          ...
          className="md:hidden bg-[#0C4F8D] p-2 rounded-full text-white"
        >
          {isMenuOpen ? 'X' : '≡'}
        </button>
      </div>
        ...
        <div className="md:hidden mt-3 bg-white rounded-2xl p-4 space-y-3 shadow-lg">
          ...
          <details>
            ...
            <div className="ml-4 mt-2 space-y-2">
              <Link href="/services/it-consultancy" className="block text-sm text-[#171824] hover:text-[#0C4F8D]" onClick={() => setIsMenuOpen(false)}>
                IT Consultancy
              </Link>
              <Link href="/services/financial-services" className="block text-sm text-[#171824] hover:text-[#0C4F8D]" onClick={() => setIsMenuOpen(false)}>
                Financial Services
              </Link>
            </div>
          </details>
